...
public class LLMockApiOptions
{
    ...
    ///     See:
    ///     https://github.com/ScottGalloway/mostlylucid.mockllmapi/blob/main/docs/MULTIPLE_LLM_BACKENDS.md#%EF%B8%8F-ollama-context-window-configuration
    /// </summary>
    ...
    ///     For example, 50 means cache will consider refreshing when
    ///     < 50% full.
