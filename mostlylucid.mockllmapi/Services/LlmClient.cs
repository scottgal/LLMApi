...
public class LlmClient
{
        ...
        HttpRequest? request = null)
    {
        ...
        if (backend == null) throw new InvalidOperationException("No LLM backend available");
        ...
        int? maxTokens = null)
    {
        ...
        if (!string.IsNullOrWhiteSpace(backendName))
        {
            ...
            if (backend == null)
            {
                _logger.LogWarning("Backend '{BackendName}' not found or disabled, using default selection",
                    backendName);
    ...
    private async Task<HttpResponseMessage> ExecuteRequestAsync(HttpClient client, object payload,
        CancellationToken cancellationToken)
    {
    ...
    private async Task<HttpResponseMessage> ExecuteStreamingRequestAsync(HttpClient client, object payload,
        CancellationToken cancellationToken)
    {
